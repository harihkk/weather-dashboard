...
function WeatherDetails({ weather, animateIn }) {
    ...
    const details = [
        ...
        },
        {
            ...
            icon: (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <path d="M12 10V2M4.93 10.93l1.41 1.41M2 18h2M20 18h2M19.07 10.93l-1.41 1.41M22 22H2M16 18a4 4 0 0 0-8 0M8 6l4 4 4-4"/>
                </svg>
            ),
            delay: 300
        },
    ...
    return (
        <section className={`weather-details ${animateIn ? 'animate-in' : ''}`}>
